...
![](./images/35b9c30313d14e349c96bbe86f4c4b3c~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](./images/2f3f9317c16f4b53ac47254cee0c2bff~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp) 当 has 为 true，就会将第一个 li 元素创建 `VNode`。
...
![image.png](./images/c27e24998c92444c83ef6ce403632531~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](./images/2f678dd2a0bc4172b711907ad9c57a4e~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](./images/9444bb3ee4034878bc1a4d6760ba4b1a~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](./images/896ca33459ec4078be095126fd2b2182~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

一般需要在某个模块、功能又或者某个路由下的`add`|`delete`|`update`|`query`进行权限控制，又或者其他的一些操作。

![](./images/bffb3a413c9f43a5a10d5c609e9cee9b~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
然后再去发送请求，但是如果一个页面有多处同时调用`v-permission`，可能会存在重复请求的问题。 ![](./images/c50402f691b24402af5d45cbbba92cff~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

所以通过 `controller.hasRequested` 和 `controller.task` 来控制请求的重复性。这个是有必要的，目前`JavaScript`中没发现类似与`Java`中的`wait/notify`（锁机制）。所以只是一个仿造Java的锁机制 ![](./images/38ecefd155fb4906921a37d52557fd87~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](./images/f55bc98465a44f48975e1da23d83aa3e~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
