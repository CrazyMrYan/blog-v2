...
![](../public/405bd8f9f99b4a7f8c2604ba7c41b488~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/ab4417e81ecb4bbcaae7d1641edacff8~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

### 实现一个简易爬虫

简单实现一个通过URL获取HTML的小功能，先请求拿到内容，然后通过`cheerio`插件选中到掘金存放文章的根元素，最后通过 `turndown` 插件转化成 Markdown。

![](../public/648b696e4596413fa6eb3b9dcfecbf35~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/68166262c2b64eb88d92a039c574f0ff~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

文件内容也都转换成功了，只是图片地址，我们还没有将图片进行保存和替换，接下来一起处理下。

![](../public/2199abbce6134060b3f7f58b45a72c44~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/fa47f389dd124cc3bd66deaa1cb07e3a~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/cbb221e4ea9741c9abb826445244859e~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp) 实现代码如下
...
![](../public/7b4941d05a9b4caea45f4cd7aa57570c~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/54a55d01127c49db9536c890bf664d04~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

掘金上被转换的链接如下

![](../public/900af397b1cf445a8037de9c094e72ff~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/cb6257c802634d0697d407f07d282338~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

### 解决语言高亮丢失的问题

可以看到目前的代码转成markdown之后，表示代码块的反应号都不见了，就是就是代码界《消失的它（\`\*3）》;

![](../public/41fa6bb9aaf74a1faf05ec686e0a53a7~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/3137ed26752540279ca7589354a4cce4~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

### 去掉掘金md样式

可以看到掘金在文章内容区域放了个 style 标签。但里面的内容并不是我们需要的 ![](../public/6251df26b243459c99e6e4f422243678~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)

![](../public/a3cabdebb7dd4e9da21333b73d64f239~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/c97792c21b094be8a67aa2c0e44798f3~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
...
![](../public/a40af40e66b64340b8fede8c43075319~tplv-k3u1fbpfcp-zoom-in-crop-mark:1512:0:0:0.webp)
