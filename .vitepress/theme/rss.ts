...
const OPTIONS: FeedOptions = {
  ...
  author: AUTHOR,
  image: "https://giao.club/avator.png",
  favicon: "https://giao.club/avator.png",
};
    ...
    await Promise.all(
      files
        ...
        .map(async (i) => {
          ...
          const html = markdown
            .render(content)
            .replaceAll('src="../public/', `src="${DOMAIN}`);
